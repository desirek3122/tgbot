...
$confirmationToken = '33cb2543';

//Ключ доступа сообщества
$token = 'd57a6370e0d7fbfe7de56a771b40fad924aba17c1fb11e6fa0719ddaa48388d88b00890b1fecb52fbd62c';
...
switch ($data->type) {
    ...
    case 'message_new':
        ...
        $userInfo = json_decode(file_get_contents("https://api.vk.com/method/users.get?user_ids=".$data->object->user_id."&access_token=$token&v=5.5"));
        ...
        $request_params = array(
            'message' => "Да, ".  $userInfo->response[0]->first_name . " ваше сообщение зарегистрировано!<br>".
        ...
        $d = array(
          'text' => "Новое сообщение в группе! От " .$userInfo->response[0]->first_name . " Ответьте как можно скорее!",
          'chat_id' => '23520120',
        )
